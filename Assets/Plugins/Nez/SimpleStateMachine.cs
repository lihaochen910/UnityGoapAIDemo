...
namespace Nez.AI.FSM
{
	...
	/// </summary>
	public class SimpleStateMachine<TEnum> : MonoBehaviour where TEnum : struct, IComparable, IFormattable
	{
...
//				Debug.Log ( $"SimpleStateMachine {previousState} => {_currentState}" );
			}
		}
		...
		public void SetState( TEnum state ) => currentState = state;


		public void GotoPreviousState() => currentState = previousState;
