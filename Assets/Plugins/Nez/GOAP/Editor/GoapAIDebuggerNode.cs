...
namespace Nez.AI.GOAP {
	public class GoapAIDebuggerNode {
		public Rect                                             rect;
		public string                                           title;
		public string                                           value;
		...
		public List< KeyValuePair< GoapAIDebuggerNode, Color > > links;
		...
		public GoapAIDebuggerNode ( float    aX,            float    aY, float aWidth, float aHeight,
			...
			links             = new List< KeyValuePair< GoapAIDebuggerNode, Color > > ();
			isActive          = true;
		}
