...
namespace Nez.AI
{
    public static class EditorHelper {
        ...
        public static bool AssertMultiObjectEditingNotSupportedHeight ( SerializedProperty property, GUIContent label,
                                                                        out float          height ) {
        ...
        public static System.Type GetTargetType ( this SerializedProperty prop ) {
            ...
            switch ( prop.propertyType ) {
                case SerializedPropertyType.Generic:
                    return prop.type.GetType () ?? typeof ( object );
        ...
        public static object GetTargetObjectOfProperty ( SerializedProperty prop ) {
            ...
            foreach ( var element in elements ) {
                if ( element.Contains ( "[" ) ) {
                    ...
                    var index = System.Convert.ToInt32 ( element
                                                         .Substring ( element.IndexOf ( "[" ) ).Replace ( "[", "" )
                                                         .Replace ( "]", "" ) );
...
//                                                         .Replace ( "]", "" ) );
//                    var arr =
//                        DynamicUtil.GetValue ( element, elementName ) as System.Collections.IList;
...
//                    DynamicUtil.SetValue ( obj, element, value );
        ...
        public static void SetEnumValue< T > ( this SerializedProperty prop, T value ) where T : struct {
            ...
            //}
            prop.intValue = Convert.ToInt32 ( value, System.Globalization.NumberFormatInfo.InvariantInfo );
        }
        ...
        public static void SetPropertyValue ( SerializedProperty prop, object value ) {
            ...
            switch ( prop.propertyType ) {
                case SerializedPropertyType.Integer:
                    ...
                    break;
                case SerializedPropertyType.Boolean:
                    prop.boolValue = Convert.ToBoolean ( value, System.Globalization.NumberFormatInfo.InvariantInfo );
                    break;
                case SerializedPropertyType.Float:
                    prop.floatValue = Convert.ToSingle ( value, System.Globalization.NumberFormatInfo.InvariantInfo );
                    break;
                case SerializedPropertyType.String:
                    prop.stringValue = Convert.ToString ( value, System.Globalization.NumberFormatInfo.InvariantInfo );
                    break;
                case SerializedPropertyType.Color:
                ...
                case SerializedPropertyType.ObjectReference:
                    ...
                    break;
                case SerializedPropertyType.LayerMask:
                    prop.intValue = ( value is LayerMask ) ? ( ( LayerMask )value ).value : Convert.ToInt32 ( value, System.Globalization.NumberFormatInfo.InvariantInfo );
                    break;
                case SerializedPropertyType.Enum:
                ...
                case SerializedPropertyType.Rect:
                    ...
                    break;
                case SerializedPropertyType.ArraySize:
                    prop.arraySize = Convert.ToInt32 ( value, System.Globalization.NumberFormatInfo.InvariantInfo );
                    break;
                case SerializedPropertyType.Character:
                    prop.intValue = Convert.ToInt32 ( value, System.Globalization.NumberFormatInfo.InvariantInfo );
                    break;
        ...
        public static void SetNumericValue ( this SerializedProperty prop, double value ) {
            switch ( prop.propertyType ) {
                case SerializedPropertyType.Integer:
                    ...
                    break;
                case SerializedPropertyType.Boolean:
                    prop.boolValue = ( System.Math.Abs ( value ) > 0 );
                    break;
                case SerializedPropertyType.Float:
                    if ( prop.type == "double" )
            ...
            foreach ( var element in elements.Take ( elements.Length - 1 ) ) {
                if ( element.Contains ( "[" ) ) {
                    ...
                    field = tp.GetMember ( elementName, MemberTypes.Field,
                              ...
                              .FirstOrDefault () as System.Reflection.FieldInfo;
