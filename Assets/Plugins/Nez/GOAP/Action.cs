...
namespace Nez.AI.GOAP
{
	public class Action
	{
		...
		public HashSet<Tuple<string,bool>> _preConditions = new HashSet<Tuple<string,bool>>();

		public HashSet<Tuple<string,bool>> _postConditions = new HashSet<Tuple<string,bool>>();
		...
		public Action setPrecondition( string conditionName, bool value )
		{
		...
		public Action setPostcondition( string conditionName, bool value )
		{
