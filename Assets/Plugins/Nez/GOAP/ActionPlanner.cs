...
namespace Nez.AI.GOAP
{
	...
	public class ActionPlanner
	{
		...
		public List<Action> _viableActions = new List<Action>();

		public event System.Action< Stack< Action > > PlanUpdated;
...
//		public Action addAction ( string name, int cost = 1 ) {
//			return addAction ( new Action ( name, cost ) );
//		}
		...
		public Stack<Action> plan( WorldState startState, WorldState goalState, List<AStarNode> selectedNodes = null )
		{
			...
			var result = AStar.plan( this, startState, goalState, selectedNodes );
